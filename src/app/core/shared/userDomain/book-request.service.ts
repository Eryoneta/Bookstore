...
import { BookListRequest, DataFormat } from './bookListRequest.interface';

@Injectable({
  providedIn: 'root'
})
export class BookRequestService implements BookListRequest {
  //LINK
  private getURL(id: string) {
    return "https://bookstore-6ee91-default-rtdb.firebaseio.com/books" + (id ? "/" + id : "") + ".json";
  }
  //MAIN
